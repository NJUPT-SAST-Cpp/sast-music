...
MusicPlayer::MusicPlayer(QObject* parent) : QMediaPlayer(parent), audioOutput(new QAudioOutput(this)) {
    ...
    QObject::connect(OutputDeviceViewModel::getInstance(), &OutputDeviceViewModel::currentIndexChanged,
                     this, &MusicPlayer::onAudioOutputDeviceChanged);
    QObject::connect(VolumeViewModel::getInstance(), &VolumeViewModel::volumeChanged,
